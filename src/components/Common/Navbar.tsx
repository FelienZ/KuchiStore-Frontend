...
export default function Navbar({ handleTrigger }: NavbarAction) {
  ...
  return (
    <NavigationMenu
      viewport={isMobile}
      className="w-screen font-[Roboto] bg-background text-foreground drop-shadow-sm border-b"
    >
        ...
        {width < 550 ? (
          ...
          <NavigationMenuItem className="flex items-center h-full gap-8">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "border-b-foreground border-b-3 h-full flex items-center gap-2 text-sm"
